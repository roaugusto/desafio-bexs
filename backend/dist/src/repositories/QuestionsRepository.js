...
var QuestionsRepository = /** @class */ (function (_super) {
    __extends(QuestionsRepository, _super);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, findQuestion || null];
                }
            });
        });
    };
    QuestionsRepository = __decorate([
        typeorm_1.EntityRepository(Question_1.default)
    ], QuestionsRepository);
